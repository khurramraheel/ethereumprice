    ...
    render(){
        return(
            ...
            <div className="col-md-4 col-12">
                <div className="card mt-3 p-4 h-100" style={{backgroundColor:'rgb(54, 151, 156)'}}>
                    <img className="card-img-top m-auto " src={img1} alt="Card image" style={{width:'30%',backgroundColor:'rgb(54, 151, 156)'}}/>
                    <div className="card-body"  style={{backgroundColor:'rgb(54, 151, 156)'}}>
                        <h4 className="card-title text-center" style={{fontSize:'18px', letterSpacing:'1px', fontWeight:'400'}}>Ethereum Price Predictions</h4>
                        <p className="card-text text-center" style={{color:"black", fontSize:'14px'}}>
                        ...
                        <a href="#" className="btn mybtn w-100">VIEW PRIDICTIONS</a>
                     </div>
                 </div>
                 </div>
            ...
            <div className="col-md-4 col-12">
                 ...
                 <div className="card mt-3 p-4 h-100" style={{backgroundColor:'rgb(54, 151, 156)'}}>
                    ...
                    <div className="card-body"  style={{backgroundColor:'rgb(54, 151, 156)'}}>
                        ...
                        <a href="#" className="btn mybtn w-100">BUY ETHEREUM</a>
                     </div>
                 </div>
                 </div>
                 <div className="col-md-4 col-12">
                 ...
                 <img className="card-img-top m-auto" src={img1} alt="Card image" style={{width:'30%',backgroundColor:'rgb(54, 151, 156)'}}/>
                    ...
                    <div className="card-body" style={{backgroundColor:'rgb(54, 151, 156)'}}>
                        ...
                        <a href="#" className="btn mybtn w-100">VIEW CALCULATOR</a>
                     </div>
                 </div>
                 </div>
             </div>
